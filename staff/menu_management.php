...
<body>
    ...
    <main>
        ...
        <div class="filter-search-wrapper">
            ...
            <form method="GET" action="menu_management.php" class="search-form" id="searchForm">
            ...
            <div class="filter-row">
                <div class="category-filter">
                    <select name="category" class="filter-select" onchange="window.location.href='menu_management.php?category=' + this.value + '<?php echo !empty($search_query) ? '&search=' . urlencode($search_query) : ''; ?>'">
        ...
        <div class="staff-menu-grid">
            ...
            <?php 
                ...
                if (!empty($search_query) || $category_filter != 'all') {
                    echo '<a href="menu_management.php" style="display: inline-block; margin-top: 10px; padding: 8px 20px; background: #007bff; color: white; text-decoration: none; border-radius: 5px;">Clear Filters</a>';
                }
                echo '</div>';
            }
            ?>
