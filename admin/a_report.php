...
<body>
    ...
    <div class="main-content staff-report-content">
        <div class="header">
            ...
            <a href="../staff/export_report.php?<?php echo buildQueryString($baseParams); ?>" target="_blank" class="export-btn">
        ...
        <form method="GET" action="" class="filters-container">
            ...
            <div class="filters-row">
                ...
                <div class="filter-group">
                    <label>&nbsp;</label>
                    <a href="a_report.php?<?php echo buildQueryString(['category' => $category, 'type' => $type]); ?>" class="filter-reset-btn">Reset</a>
                </div>
                <?php endif; ?>
            </div>
        </form>
