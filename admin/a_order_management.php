...
<head>
    ...
    <title>SmartServe - Order Management</title>
        ...
        <div class="sidebar-top">
           ...
           <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="active"><a href="a_order_management.php"><span class="material-symbols-outlined">order_approve</span> Orders</a></li>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <?php if ($status_filter != 'all'): ?>
                        <a href="a_order_management.php?status=all" class="filter-btn" style="margin-top: 10px; display: inline-block;">
                            View All Orders
                        </a>
                    <?php endif; ?>
                </div>
